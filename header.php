...
if (empty($_SESSION["user_id"])) {
    $header = '<nav><a href="registration.php" class="logInHeaderButton">Register</a><a href="login.php" class="logInHeaderButton">Log in</a></nav>';
} else {
...
<div class="headerContainer">
    <header>
        <div><a href="index.php?page=0"><img src="img/logo_placeholder.png" alt="FxLoL web logo" srcset=""></a></div>
        <?php echo $header ?>
    </header>
</div>